...
└── requirements.txt         # Зависимости проекта (устаревший способ)
```
...
```bash
poetry install  # установка всех зависимостей, включая разработческие
# или
poetry install --without dev  # только основные зависимости, без инструментов разработки
```
...
### Установка с использованием pip (устаревший способ)
